...
public class Server4 extends JFrame {
    ...
    public Server4() {
        JFrame mainFrm = new JFrame("Hệ Thống Rạp Phim - Server 4");
        ...
        scroll.setBorder(
                BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.blue, 2), "MÁY CHỦ 4 - RẠP PHIM",
    ...
    public static class sv4 implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                gs.getCurrentCircle();
                gs.sendUpdate("127.0.0.1", 2004, "Server4"); // Đẩy sang Server 5

                ServerSocket server = new ServerSocket(2004); // Cổng của Server 4
                while (true) {
                    int localPort = server.getLocalPort();
                    display.append("Server 4 đang lắng nghe tại cổng " + localPort + ".\n");
                    Socket client = server.accept();
                    apps.handler(client, "Server4", 4, currentCircle, hash); // Pos = 4
                    apps.runServer();
    ...
    public static class getLamports implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                int max;
                while (true) {
                    String address = "225.4.5.6"; // IP Multicast của Server 4
