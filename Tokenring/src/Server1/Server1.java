...
public class Server1 extends JFrame {
    ...
    public Server1() {
        JFrame mainFrm = new JFrame("Hệ Thống Rạp Phim - Server 1");
        ...
        scroll.setBorder(
                BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.blue, 2), "MÁY CHỦ 1 - RẠP PHIM",
    ...
    public static class sv1 implements Runnable {
        ...
        public void runServer() {
            try {
                ...
                // // 👉 HIỂN THỊ dữ liệu client gửi
                // if (request != null) {
                // display.append("Nhận được: " + request + "\n");
                // }
        ...
        public void run() {
            ...
            try {
                ...
                while (true) {
                    ...
                    display.append("Server 1 đang lắng nghe tại cổng " + localPort + ".\n");
