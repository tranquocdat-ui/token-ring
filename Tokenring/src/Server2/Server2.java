...
public class Server2 extends JFrame {
    ...
    public Server2() {
        JFrame mainFrm = new JFrame("Hệ Thống Rạp Phim - Server 2");
        ...
        // Đổi tiêu đề viền
        scroll.setBorder(
                BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.blue, 2), "MÁY CHỦ 2 - RẠP PHIM",
    ...
    public static class sv2 implements Runnable {
        ...
        public void runServer() {
            try {
                ...
                // String reply = "Ket noi thanh cong";
        ...
        public void run() {
            ...
            try {
                ...
                gs.getCurrentCircle();
                // Gửi update cho vòng tròn tiếp theo (Server 3 ở cổng 2004 theo code cũ, tui
                // giữ nguyên)
                gs.sendUpdate("127.0.0.1", 2002, "Server2");

                // Lắng nghe TCP ở cổng 2002
                ServerSocket server = new ServerSocket(2002);
                while (true) {
                    int localPort = server.getLocalPort();
                    display.append("Server 2 đang lắng nghe tại cổng " + localPort + ".\n");
